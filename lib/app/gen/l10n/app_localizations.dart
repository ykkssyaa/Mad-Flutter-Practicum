...
abstract class AppLocalizations {
  ...
  /// No description provided for @currencyLoadFailedTryLater.
  ///
  /// In ru, this message translates to:
  ...
  /// No description provided for @newsLoadFailedTryLater.
  ///
  /// In ru, this message translates to:
  ...
  ///
  /// In ru, this message translates to:
  /// **'{value, plural, one{({value} штука)} few{({value} штуки)} many{({value} штук)} other{({value} штуки)}}'**
